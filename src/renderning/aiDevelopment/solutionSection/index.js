        ...
        <div className="container-lg">
            <div className={styles.solutionSection}>
                <div className="container">
                    ...
                    <p>
                        Here is the real-time data to identify and understand impact on the business when businesses are moving into AI/ML solutions:
                    </p>
                    <div className={styles.grid}>
                        <div className={styles.griditems}>
                            ...
                            <span>of companies report that AI and ML has provided them with a competitive advantage in the market.</span>
                        </div>
                        <div className={styles.griditems}>
                            <h3>
                            80%
                            </h3>
                            <span>of enterprises are investing in AI and Machine Learning with the aim of increasing their productivity.</span>
                        </div>
                        <div className={styles.griditems}>
                            <h3>76%</h3>
                            <span>of companies increased their ability to provide great customer experience with AI and ML based personalization.</span>
                        </div>
                        <div className={styles.griditems}>
                            <h3>70%</h3>
                            <span>of businesses have already realized benefits to decision-making and enhancements to their business processes from leveraging AI and ML insights.</span>
                        </div>
                    </div>
                </div>
            </div>
