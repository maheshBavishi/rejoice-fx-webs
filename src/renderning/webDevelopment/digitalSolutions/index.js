            ...
            <div className="container">
                <div className={styles.grid}>
                    ...
                    <div className={styles.griditems}>
                        ...
                        <h2>
                            Why Rejoice FX for Mobile & Web Development?
                        </h2>
                        <p>
                            At Rejoice FX, we don’t just build mobile apps and websites—we craft digital experiences that empower your business. Our team combines technical expertise, creative design, and a deep understanding of industry trends to deliver cutting-edge
