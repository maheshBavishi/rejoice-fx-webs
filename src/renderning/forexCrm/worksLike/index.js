                ...
                <div className={styles.griditems}>
                    ...
                    <div className={styles.twoCol}>
                        <div className={styles.twoColitems}>
                            ...
                            <p>
                            Client-Focused Solutions Since 2014
                            </p>
                            <span>
                            Client-oriented since 2014. We offer user-friendly solutions with helpful guides and educational sessions to easily work 
                            with our products
                            </span>
                        </div>
                        <div className={styles.twoColitems}>
